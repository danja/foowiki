        ...
        function reviseHref(aElement) {
            ...
            if (linkText) {
                ...
                if (location.href == oldHref) { // link href was blank
                    var before = window.location.protocol + "//" + window.location.hostname + ":" + window.location.port + FooWiki.serverRootPath + "page-static.html?uri=" + FooWiki.pagesBaseURI;
                    ...
                    return FooWiki.serverRootPath + "page-static.html?uri=" + FooWiki.pagesBaseURI + localRef;
                }
            }

...
new Function(...keys, "return " + raw + ""): This creates a new Function object with the keys as parameters and the template string concatenated with raw as the function body.

(...values): This immediately calls the newly created function with the values as arguments.

using new Function() with user-provided input can be a security risk, so ensure the raw string is safe and trusted to avoid potential security vulnerabilities.
